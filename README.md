...
- [MailJobTimeLine_DE.sql](../master/MailJobTimeLine_DE.sql) - This SQL (german, theres also an not so actual english version [MailJobTimeLine_DE.sql](../master/MailJobTimeLine_DE.sql)) sends an email with all jobs displayed in a graphical timeline:
